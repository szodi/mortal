...
public class GifSequenceWriter
{
	...
	public static void write(File destination, int delayMS, boolean loop, BufferedImage... bufferedImages) throws FileNotFoundException, IOException
	{
		ImageOutputStream output = new FileImageOutputStream(destination);
		GifSequenceWriter writer = new GifSequenceWriter(new FileImageOutputStream(destination), bufferedImages[0].getType(), delayMS, loop);
